...
import { createNewsletter } from '../redux/actions';
              ...
              <div className="col-md-3 col-sm-6">
                <div className="footer_widget">
                  ...
                  <div className="footer_content">
                    ...
                    <form className="pt_15 form_3" onSubmit={this.handleSubmit} autoComplete="off">
...
const mapDispatchToProps = dispatch => ({
  createNewsletter: bindActionCreators(email => createNewsletter(email), dispatch)
});
